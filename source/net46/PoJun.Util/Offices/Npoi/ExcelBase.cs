...
using PoJun.Util.Offices.Abstractions;
...
namespace PoJun.Util.Offices.Npoi
{
    ...
    public abstract class ExcelBase : IExcel
    {
        ...
        /// <param name="style">单元格样式</param>
        public IExcel HeadStyle(PoJun.Util.Offices.Core.Table table, CellStyle style)
        {
            if (_headStyle == null)
        ...
        /// <param name="table">表格</param>
        /// <param name="style">单元格样式</param>
        public IExcel BodyStyle(PoJun.Util.Offices.Core.Table table, CellStyle style)
        {
            if (_bodyStyle == null)
        ...
        /// <param name="table">表格</param>
        /// <param name="style">单元格样式</param>
        public IExcel FootStyle(PoJun.Util.Offices.Core.Table table, CellStyle style)
        {
            if (_footStyle == null)
