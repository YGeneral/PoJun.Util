...
namespace PoJun.Util.Tests.Helpers {
    ...
    public class EnumTest {
        ...
        public void TestParse_MemberIsEmpty( string member ) {
            AssertHelper.Throws<ArgumentNullException>( () => { PoJun.Util.Helpers.Enum.Parse<EnumSample>( member ); }, "member" );
        }
        ...
        public void TestGetValue_Validate() {
            AssertHelper.Throws<ArgumentNullException>( () => PoJun.Util.Helpers.Enum.GetValue<EnumSample>( null ), "member" );
            AssertHelper.Throws<ArgumentNullException>( () => PoJun.Util.Helpers.Enum.GetValue<EnumSample>( string.Empty ), "member" );
            AssertHelper.Throws<ArgumentNullException>( () => PoJun.Util.Helpers.Enum.GetValue<Sample>( string.Empty ), "member" );
        }
        ...
        public void TestGetItems_Validate() {
            AssertHelper.Throws<InvalidOperationException>( () => {
                PoJun.Util.Helpers.Enum.GetItems<Sample>();
            }, "类型 PoJun.Util.Tests.Samples.Sample 不是枚举" );
        }
    }
}
