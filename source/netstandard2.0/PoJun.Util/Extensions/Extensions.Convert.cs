...
namespace PoJun.Util
{
    ...
    public static partial class Extensions
    {
        ...
        {
            return PoJun.Util.Helpers.Convert.ToBool(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToBoolOrNull(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToInt(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToIntOrNull(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToLong(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToLongOrNull(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToDouble(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToDoubleOrNull(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToDecimal(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToDecimalOrNull(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToDate(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToDateOrNull(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToGuid(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToGuidOrNull(obj);
        }
        ...
        {
            return PoJun.Util.Helpers.Convert.ToGuidList(obj);
        }
